...
<!-- <script src="{{ asset('website/assets/vendor/jquery/dist/jquery.min.js')}}"></script> -->
<script src="{{ asset('website/assets/vendor/jquery-migrate/dist/jquery-migrate.min.js')}}"></script>
<!-- <script src="{{ asset('website/assets/vendor/popper.js/dist/umd/popper.min.js')}}"></script> -->
<!-- <script src="{{ asset('website/assets/vendor/bootstrap/bootstrap.min.js')}}"></script> -->

<!-- JS Implementing Plugins -->
<script src="{{ asset('website/assets/vendor/appear.js')}}"></script>
<script src="{{ asset('website/assets/vendor/jquery.countdown.min.js')}}"></script>
<script src="{{ asset('website/assets/vendor/hs-megamenu/src/hs.megamenu.js')}}"></script>
<script src="{{ asset('website/assets/vendor/svg-injector/dist/svg-injector.min.js')}}"></script>
...
<!-- JS Electro -->
<script src="{{ asset('website/assets/js/hs.core.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.countdown.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.header.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.hamburgers.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.unfold.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.focus-state.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.malihu-scrollbar.js')}}"></script>
<script src="{{ asset('website/assets/js/components/hs.validation.js')}}"></script>
