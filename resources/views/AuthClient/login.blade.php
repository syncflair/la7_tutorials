...
<div class="login-box" id="app">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">{{ __('Client Login') }}</p>
      ...
      <!-- <form method="POST" action="{{ route('login') }}"> -->
        ...
        <div class="input-group mb-3">
          <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required- autocomplete="username" placeholder="{{ __('E-Mail Address') }}" autofocus>          
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
