...
@section('content')
  ...
  <p class="mt-10 mb-10">
    ...
    @if($email_data['tag'] == 'PasswordChangeByAdminChild')
      <strong>Congratulation</strong>, Your password has been changed successfully. Keep safe your login credential. Your Login credential details bellow: <br>
    @endif 
