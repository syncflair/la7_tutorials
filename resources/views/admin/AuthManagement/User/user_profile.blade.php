            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  @if(!empty(UserAvatar()))
                    <img class="profile-user-img img-fluid img-circle" src="{{ UserAvatar() }}" alt="User profile picture" style="width: 150px !important; height: 150px;">
                  @else
                    <img class="profile-user-img img-fluid img-circle" src="{{asset('FilesStorage/CommonFiles/avatar.png')}}" alt="User profile picture" style="width: 150px !important; height: 150px;">           
                  @endif
                </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="{{asset('backend/AdminLTE/img/user1-128x128.jpg')}}" alt="user image">
                        <span class="username">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="{{asset('backend/AdminLTE/img/user7-128x128.jpg')}}" alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="{{asset('backend/AdminLTE/img/user6-128x128.jpg')}}" alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src="{{asset('backend/AdminLTE/img/photo1.png')}}" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="{{asset('backend/AdminLTE/img/photo2.png')}}" alt="Photo">
                              <img class="img-fluid" src="{{asset('backend/AdminLTE/dist/img/photo3.jpg')}}" alt="Photo">
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="{{asset('backend/AdminLTE/img/photo4.jpg')}}" alt="Photo">
                              <img class="img-fluid" src="{{asset('backend/AdminLTE/img/photo1.png')}}" alt="Photo">
                            </div>
                            <!-- /.col -->
                          </div>
                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    @include('admin.AuthManagement.User.user_profile_form')
...
@section('extra_script')
  ...
  $( window ).on( "load", function(){
    ...
    var urlTo = "{{ route('profile.edit', ':id') }}" 
  ...
  $(function(){      
    $('#user_profile_form').on('submit', function (e) {
      ...
      var id = $('#id').val(); 
      var urlTo = "{{ route('profile.update', ':id') }}" ;
