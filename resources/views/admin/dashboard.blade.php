              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{asset('backend/AdminLTE/img/user1-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{asset('backend/AdminLTE/img/user3-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('backend/AdminLTE/img/user1-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('backend/AdminLTE/img/user7-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('backend/AdminLTE/img/user3-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('backend/AdminLTE/img/user5-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('backend/AdminLTE/img/user6-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('backend/AdminLTE/img/user8-128x128.jpg')}}">
