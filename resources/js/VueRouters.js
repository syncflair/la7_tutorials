...
//export const routes = [
	...
	{ path: '/home', name: 'PublicMaster', component: () => import(/* webpackChunkName: "PublicMaster-website" */ './components/Website/Public/PublicMaster.vue'), meta: { title: 'Welcome To Sorboraho'},
	  children: [
