...
//export const routes = [
	...
	{ path: '/shop', name: 'ShopPublic', component: () => import(/* webpackChunkName: "ShopPublic-website" */ './components/Website/Public/Shop/ShopPublic.vue'), meta: { title: 'Shop'} },
	{ path: '/categories', name: 'CategoriesPublic', component: () => import(/* webpackChunkName: "CategoriesPublic-website" */ './components/Website/Public/Category/CategoriesPublic.vue'), },
	{ path: '/deals-of-day', name: 'DealsListPublic', component: () => import(/* webpackChunkName: "DealsListPublic-website" */ './components/Website/Public/Deals/DealsListPublic.vue'), meta: { title: 'Brands'} },
	{ path: '/brands', name: 'BrandsListPublic', component: () => import(/* webpackChunkName: "BrandsListPublic-website" */ './components/Website/Public/Brand/BrandsListPublic.vue'), meta: { title: 'Brands'} },
	...
	{ path: '/brand-shops', name: 'BrandShopsListPublic', component: () => import(/* webpackChunkName: "BrandShopsListPublic-website" */ './components/Website/Public/BrandShop/BrandShopsListPublic.vue'), meta: { title: 'Brand Shops'} },
	{ path: '/brand-shop', name: 'BrandShopPublic', component: () => import(/* webpackChunkName: "BrandShopPublic-website" */ './components/Website/Public/BrandShop/BrandShopPublic.vue'), meta: { title: 'Brand Shops'} },
	{ path: '/single-product', name: 'SingleProductPublic', component: () => import(/* webpackChunkName: "SingleProductPublic-website" */ './components/Website/Public/Product/SingleProductPublic.vue'),  },
	{ path: '/contact', name: 'ContactPublic', component: () => import(/* webpackChunkName: "ContactPublic-website" */ './components/Website/Public/Contact/ContactPublic.vue'), meta: { title: 'Contact'} },
	{ path: '/about', name: 'AboutUsPublic', component: () => import(/* webpackChunkName: "AboutUsPublic-website" */ './components/Website/Public/About/AboutUsPublic.vue'), meta: { title: 'About Us'} },
	{ path: '/gift-card', name: 'GiftCardPublic', component: () => import(/* webpackChunkName: "GiftCardPublic-website" */ './components/Website/Public/GiftCard/GiftCardPublic.vue'), meta: { title: 'Gift Card'} },
	{ path: '/membership', name: 'MembershipPublic', component: () => import(/* webpackChunkName: "MembershipPublic-website" */ './components/Website/Public/Membership/MembershipPublic.vue'), meta: { title: 'Membership'} },
	{ path: '/terms-and-conditions', name: 'TermsAndConditionsPublic', component: () => import(/* webpackChunkName: "TermsAndConditionsPublic-website" */ './components/Website/Public/TAC/TermsAndConditionsPublic.vue'), },
	{ path: '/faq', name: 'FAQPublic', component: () => import(/* webpackChunkName: "FAQPublic-website" */ './components/Website/Public/FAQ/FAQPublic.vue'), meta: { title: 'FAQ'} },
	{ path: '/track-order', name: 'TrackYourOrder', component: () => import(/* webpackChunkName: "TrackYourOrder-website" */ './components/Website/Public/TrackOrder/TrackYourOrder.vue'), meta: { title: 'Track Order'} },
	{ path: '/cart', name: 'CartPublic', component: () => import(/* webpackChunkName: "CartPublic-website" */ './components/Website/Public/Cart/CartPublic.vue'), meta: { title: 'Cart'}},
	{ path: '/checkout', name: 'CheckoutPublic', component: () => import(/* webpackChunkName: "CheckoutPublic-website" */ './components/Website/Public/Checkout/CheckoutPublic.vue'), meta: { title: 'Checkout'}},
	{ path: '/wishlist', name: 'WishlistPublic', component: () => import(/* webpackChunkName: "WishlistPublic-website" */ './components/Website/Public/Wishlist/WishlistPublic.vue'), meta: { title: 'Wishlist'}},
	{ path: '/compare', name: 'ComparePublic', component: () => import(/* webpackChunkName: "ComparePublic-website" */ './components/Website/Public/Compare/ComparePublic.vue'), meta: { title: 'Wishlist'}},
	{ path: '/my-account', name: 'MyAccountPublic', component: () => import(/* webpackChunkName: "MyAccountPublic-website" */ './components/Website/Public/MyAccount/MyAccountPublic.vue'), meta: { title: 'My Account'}},
	{ path: '/404', name: '404Public', component: () => import(/* webpackChunkName: "404Public-website" */ './components/Website/Public/404/404Public.vue'), meta: { title: 'Page Not Found'}},

	//website user admin dashboard
  	{ path: '/customer-dashboard', name: 'CustomerDashboard', component: () => import(/* webpackChunkName: "customer-dashboard-website-auth" */ './components/Website/AdminCustomer/Dashboard/CustomerDashboard.vue'), },
  	{ path: '/customer-orders', name: 'CustomerOrder', component: () => import(/* webpackChunkName: "customer-order-website-auth" */ './components/Website/AdminCustomer/Order/CustomerOrders.vue'), },
  	{ path: '/customer-profile', name: 'CustomerProfile', component: () => import(/* webpackChunkName: "customer-profile-website-auth" */ './components/Website/AdminCustomer/Profile/CustomerProfile.vue'), },
  	{ path: '/customer-address', name: 'CustomerAddress', component: () => import(/* webpackChunkName: "customer-address-website-auth" */ './components/Website/AdminCustomer/Profile/CustomerAddress.vue'), },
  	{ path: '/customer-wishlist', name: 'CustomerWishlist', component: () => import(/* webpackChunkName: "customer-wishlist-website-auth" */ './components/Website/AdminCustomer/Wishlist/CustomerWishlist.vue'), },
  	{ path: '/customer-vouchers', name: 'CustomerVoucher', component: () => import(/* webpackChunkName: "customer-voucher-website-auth" */ './components/Website/AdminCustomer/Voucher/CustomerVoucher.vue'), },
  	{ path: '/customer-reviews', name: 'CustomerReviews', component: () => import(/* webpackChunkName: "customer-reviews-website-auth" */ './components/Website/AdminCustomer/Review/CustomerReviews.vue'), },
