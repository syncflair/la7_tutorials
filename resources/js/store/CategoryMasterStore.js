const CategoryMasterStore ={
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/CategoryMaster-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default CategoryMasterStore