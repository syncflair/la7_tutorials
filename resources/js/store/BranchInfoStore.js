const BranchInfoStore ={
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/Branch-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default BranchInfoStore