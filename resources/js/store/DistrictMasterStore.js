const DistrictMasterStore ={
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/District-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default DistrictMasterStore