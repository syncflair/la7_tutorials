const BrandShopMasterStore ={
    ...
    mutations: {        
        ...
        FETCH_DATA(state, BrandShops) {
            return state.BrandShops = BrandShops;                        
        },
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/BrandShop-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default BrandShopMasterStore