const SpecificationMasterStore ={
    ...
    mutations: {
        ...
        FETCH_DATA(state, Specification) {
            return state.Specifications = Specification;                        
        },
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/Specification-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default SpecificationMasterStore