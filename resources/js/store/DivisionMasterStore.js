const DivisionMasterStore ={
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/Division-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default DivisionMasterStore