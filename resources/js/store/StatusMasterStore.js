const StatusMasterStore ={
    ...
    mutations: {
        ...
        FETCH_DATA(state, StatusMaster) {
            return state.StatusMaster = StatusMaster;                        
        },
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/StatusMaster-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default StatusMasterStore