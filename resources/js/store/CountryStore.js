const CountryStore ={
    ...
    actions: {
        fetchCountry(context, payload){
          ...
          axios.get('/spa/Country-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
        ...
        searching(context, payload){        
            ...
            axios.get('/spa/searchCountryData?page='+ 
