const CashAccountMasterStore ={
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/CashAccount-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
        ...
        AutoCompleteSearch(context, payload){  
            ...
            //axios.get('/spa/searchCashData?q='+query)
            .then( ( response ) => {
                    context.commit('AUTO_COMPLETE_DATA', response.data);
...
export default CashAccountMasterStore