const AttributeValueMasterStore ={
    ...
    mutations: {        
        ...
        FETCH_DATA(state, AttributeValue) {
            return state.AttributeValues = AttributeValue;                        
        },
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/AttributeValue-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
...
export default AttributeValueMasterStore