const VatRatesStore ={
    ...
    mutations: {
        ...
        FETCH_DATA(state, VatRates) {
            return state.VatRates = VatRates;                        
        },
    ...
    actions: {
        fetchData(context, payload){
          ...
          axios.get('/spa/VatRate-Info?page=' + context.state.pagination.current_page +'&perPage=' + perPageVelue)
          .then( (response) => {
