        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="card mb-3 border-0 text-center rounded-0">
                    <img class="img-fluid mb-3" src="website/assets/img/500X300/img1.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="card mb-3 border-0 text-center rounded-0">
                    <img class="img-fluid mb-3" src="website/assets/img/500X300/img2.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-3 border-0 text-center rounded-0">
                    <img class="img-fluid mb-3" src="website/assets/img/500X300/img3.jpg" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-5 mb-xl-0 col-xl text-center">
                    <img class="img-fluid mb-3 rounded-circle" src="website/assets/img/300X300/img16.jpg" alt="Card image cap">
                    <h2 class="font-size-18 font-weight-semi-bold mb-0">Thomas Snow</h2>
                    <span class="text-gray-41">CEO/Founder</span>
                </div>
                <div class="col-md-4 mb-5 mb-xl-0 col-xl text-center">
                    <img class="img-fluid mb-3 rounded-circle" src="website/assets/img/300X300/img17.jpg" alt="Card image cap">
                    <h2 class="font-size-18 font-weight-semi-bold mb-0">Anna Baranov</h2>
                    <span class="text-gray-41">Client Care</span>
                </div>
                <div class="col-md-4 mb-5 mb-xl-0 col-xl text-center">
                    <img class="img-fluid mb-3 rounded-circle" src="website/assets/img/300X300/img18.jpg" alt="Card image cap">
                    <h2 class="font-size-18 font-weight-semi-bold mb-0">Andre Kowalsy</h2>
                    <span class="text-gray-41">Support Boss</span>
                </div>
                <div class="col-md-4 mb-5 mb-xl-0 col-xl text-center">
                    <img class="img-fluid mb-3 rounded-circle" src="website/assets/img/300X300/img19.jpg" alt="Card image cap">
                    <h2 class="font-size-18 font-weight-semi-bold mb-0">Pamela Doe</h2>
                    <span class="text-gray-41">Delivery Driver</span>
                </div>
                <div class="col-md-4 mb-5 mb-xl-0 col-xl text-center">
                    <img class="img-fluid mb-3 rounded-circle" src="website/assets/img/300X300/img20.jpg" alt="Card image cap">
                    <h2 class="font-size-18 font-weight-semi-bold mb-0">Susan McCain</h2>
                    <span class="text-gray-41">Packaging Girl</span>
                </div>
                <div class="col-md-4 mb-5 mb-xl-0 col-xl text-center">
                    <img class="img-fluid mb-3 rounded-circle" src="website/assets/img/300X300/img21.png" alt="Card image cap">
