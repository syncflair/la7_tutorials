...
<script>
    ...
    export default {
        ...
        computed: {
          ...
          ...mapState( 'AuthenticationForCustomer', ['authCustomer','authCustomerAddress'] ),
                    ...
                    if ( result.value ) {  
                      axios.delete('/auth/my-address/'+id)
                        .then( ({data}) => {
                          ...
                          if(data.success){
                            this.$store.dispatch('AuthenticationForCustomer/fetchAuthCustomerAddress', this.authCustomer.id);
