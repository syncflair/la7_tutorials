        ...
        <div class="row mb-5 mt-4">
            ...
            <div class="bg-gray-1 rounded-lg col-xl-10 col-wd-9gdot5-">
                <div class="row ">
                    ...
                    <div class="col-12 mb-8 w-100 wishlist-table cart-wishlist-custome">
                        <!-- Profile Form -->
                            ...
                            <div class="row text-center-">
                                ...
                                <div class="col-md-4">
                                    <div class="js-form-message mb-2">
                                        ...
                                        <select v-model="form.district_id" class="form-control js-select selectpicker dropdown-select"
                                            data-live-search="true"
                                            data-style="form-control border-color-1 font-weight-normal" name="district_id" :class="{ 'is-invalid': form.errors.has('district_id') }">
