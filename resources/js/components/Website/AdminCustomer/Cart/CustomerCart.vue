        ...
        <div class="row mb-10 mt-4">
            ...
            <div class="bg-gray-1 rounded-lg col-xl-10 col-wd-9gdot5-">
                <div class="row ">
                            ...
                            <table class="table" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product-quantity w-lg-17">Quantity</th>
                                ...
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td class="d-none d-md-table-cell">
                                            <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1" :src="baseURL+'/website/assets/img/300X300/img6.jpg'" alt="Image Description"></a>
                                        </td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="d-none d-md-table-cell">
                                            <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1" :src="baseURL+'/website/assets/img/300X300/img7.png'" alt="Image Description"></a>
                                        </td>
                    ...
                    <div class="mb-8 w-100 cart-total">
                        <div class="row">
