...
<div class="mb-3">
    <div class="d-flex border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-sm-bottom-0 mb-2 mb-md-0">
        <h3 class="section-title section-title__full mb-0 pb-2 font-size-22">Shop By Brand Shop (Top Shop) </h3>
        ...
        <router-link to="/brand-shops" class="ml-md-auto d-block text-gray-16 align-self-center">Go to Brand Shop<i class="ec ec-arrow-right-categproes"></i></router-link>
    </div>
