...
<div class="mb-3">
    <div class="d-flex border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-sm-bottom-0 mb-2 mb-md-0">
        ...
        <router-link class="ml-md-auto d-block text-gray-16 align-self-center" to="/deals-of-day">Go to Daily Deals Section <i class="ec ec-arrow-right-categproes"></i></router-link>
    </div>
