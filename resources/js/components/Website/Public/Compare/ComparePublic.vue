                    ...
                    <tr>
                            ...
                            <a href="#" class="product d-block">
                                <div class="product-compare-image">
                                    <div class="d-flex mb-3">
                                        <img class="img-fluid mx-auto" src="website/assets/img/212X200/img1.jpg" alt="Image Description">
                                    </div>
                                </div>
                        ...
                        <td>
                            <a href="#" class="product">
                                <div class="product-compare-image">
                                    <div class="d-flex mb-3">
                                        <img class="img-fluid mx-auto" src="website/assets/img/212X200/img6.jpg" alt="Image Description">
                                    </div>
                                </div>
                        ...
                        <td>
                            <a href="#" class="product">
                                <div class="product-compare-image">
                                    <div class="d-flex mb-3">
                                        <img class="img-fluid mx-auto" src="website/assets/img/212X200/img7.jpg" alt="Image Description">
                                    </div>
                                </div>
                        ...
                        <td>
                            <a href="#" class="product">
                                <div class="product-compare-image">
                                    <div class="d-flex mb-3">
                                        <img class="img-fluid mx-auto" src="website/assets/img/212X200/img8.jpg" alt="Image Description">
                                    </div>
                                </div>
