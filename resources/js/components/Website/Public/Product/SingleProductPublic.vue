            ...
            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                <div class="mb-8 border border-width-2 border-color-3 borders-radius-6">
                    ...
                    <ul id="sidebarNav" class="list-unstyled mb-0 sidebar-navbar">
                        ...
                        <li>
                            <a class="dropdown-current" href="#">Accessories</a>

                            <ul class="list-unstyled dropdown-list">
                                <!-- Menu List -->
                                <li><a class="dropdown-item" href="#">Cases<span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></a></li>
                                <li><a class="dropdown-item" href="#">Chargers<span class="text-gray-25 font-size-12 font-weight-normal"> (51)</span></a></li>
                                <li><a class="dropdown-item" href="#">Headphone Cases<span class="text-gray-25 font-size-12 font-weight-normal"> (44)</span></a></li>
                                <li><a class="dropdown-item active" href="#">Headphones<span class="text-gray-25 font-size-12 font-weight-normal"> (89)</span></a></li>
                    ...
                    <ul class="list-unstyled">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="website/assets/img/300X300/img1.jpg" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="website/assets/img/300X300/img3.jpg" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="../shop/single-product-fullwidth.html">Notebook Black Spire V Nitro VN7-591G</a></h3>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="website/assets/img/300X300/img5.jpg" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="website/assets/img/300X300/img6.jpg" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="website/assets/img/300X300/img10.png" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-4 mb-md-0">
                            <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2"
                                ...
                                <div class="js-slide">
                                    <img class="img-fluid" src="website/assets/img/720X660/img1.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid" src="website/assets/img/720X660/img2.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid" src="website/assets/img/720X660/img3.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid" src="website/assets/img/720X660/img4.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid" src="website/assets/img/720X660/img5.jpg" alt="Image Description">
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="border-bottom mb-3 pb-md-1 pb-3">
                                    ...
                                    <div class="d-md-flex align-items-center">
                                        <a href="#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img class="img-fluid" src="website/assets/img/200X60/img1.png" alt="Image Description"></a>
                            ...
                            <div class="tab-pane fade" id="Jpills-two-example1" role="tabpanel" aria-labelledby="Jpills-two-example1-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <img class="img-fluid mr-n4 mr-lg-n10" src="website/assets/img/580X580/img1.jpg" alt="Image Description">
                                    </div>
                                    <div class="col-md-6 text-left">
                                        <img class="img-fluid ml-n4 ml-lg-n10" src="website/assets/img/580X580/img2.jpg" alt="Image Description">
                                    </div>
                ...
                <div class="mb-6">
                    ...
                    <ul class="row list-unstyled products-group no-gutters">
                        ...
                        <li class="col-6 col-md-3 col-wd-2gdot4 product-item remove-divider d-md-none d-wd-block">
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner px-xl-4 p-3">
                                    <div class="product-item__body pb-xl-2">
                                        <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
