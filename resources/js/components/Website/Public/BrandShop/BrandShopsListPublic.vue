            ...
            <div class="my-md-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        ...
                        <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Brand Shops</li>
                    </ol>
                </nav>
            </div>
            <!-- End breadcrumb -->
    ...
    <div class="container">
        <div class="mb-12">
            ...
            <!-- <div class="flex-center-between mb-3">
                <h3 class="font-size-25 mb-0">Brands</h3>
            ...
            <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                ...
                <div class="px-3 d-none d-xl-block">
                	<h3 class="font-size-25 mb-0">Brand Shops</h3>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade pt-2 show active" id="pills-one-example1" role="tabpanel" aria-labelledby="pills-one-example1-tab" data-target-group="groups">
                    <ul class="row list-unstyled products-group no-gutters">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner px-xl-4 p-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <router-link to="/brand-shop" class="d-block text-center"><img class="img-fluid" src="website/assets/img/212X200/img1.jpg" alt="Image Description"></router-link>
                                        </div>
                                        <div class="mb-2" style="text-align: center;"><router-link to="/brand-shop" class="font-size-12 text-gray-5">Speakers</router-link></div>
                        ...
                        </li><li class="col-6 col-md-3 col-xl-1gdot7 product-item">
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner px-xl-4 p-3">
                                    <div class="product-item__body pb-xl-2">
                ...
                <div class="tab-pane fade pt-2" id="pills-two-example1" role="tabpanel" aria-labelledby="pills-two-example1-tab" data-target-group="groups">
                    <ul class="row list-unstyled products-group no-gutters">
                        ...
                        <li class="col-6 col-md-3 col-xl-1gdot7 product-item remove-divider-md-lg">
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner px-xl-4 p-3">
                                    <div class="product-item__body pb-xl-2">
                                        <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                        ...
                        <li class="col-6 col-md-3 col-xl-1gdot7 product-item remove-divider">
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner px-xl-4 p-3">
                                    <div class="product-item__body pb-xl-2">
                                        <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
