        ...
        <div class="bg-gray-1 rounded-lg col-xl-10 col-wd-9gdot5-">
            <div class="row ">
                ...
                <div class="col-lg-12 border-bottom border-color-1 mb-3 col-6-">
                    <h3 class="section-title- mb-0 pb-1 pl-2- font-size-18">Payment Receivable</h3>
                </div>
                ...
                <div class="d-md-flex text-center col-12">
                    ...
                    <a href="../shop/checkout.html" class="btn btn-xs btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100- w-md-auto d-none- d-md-inline-block">Out of Stock</a>                    
                    <a href="../shop/checkout.html" class="btn btn-xs btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100- w-md-auto d-none- d-md-inline-block">Aproved</a>
                    <a href="../shop/checkout.html" class="btn btn-xs btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100- w-md-auto d-none- d-md-inline-block">Not Aprove</a>
                </div>
                        ...
                        <div class="table-responsive-">
                            <table class="table" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td class="d-none d-md-table-cell">
                                            <a href="#"><img class="img-fluid max-width-70 p-1 border border-color-1" src="/../website/assets/img/300X300/img7.png" loading="lazy" alt="Image Description"></a>
                                        </td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-2 px-md-2 px-lg-2 w-100 w-100- w-md-auto">Manage</button>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td class="d-none d-md-table-cell">
