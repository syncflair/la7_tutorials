    ...
    <div class="card-header">      
      <div class="row">
        ...
        <div class="col-md-7 col-sm-3 text-right">
        	<a @click="addData" class="btn btn-primary btn-flat btn-sm" data-toggle="modal" data-target="#userModal"> <i class="icon fas fa-plus"></i> Add New</a>
        </div>
      </div>
    </div><!--/card-header-->
    <div class="card-body">   
        ...
        <tbody>
          ...
          <tr v-for="(user, index) in sortedObjects" :key="index">
            ...
            <td style="text-align:center;">
            	<span v-show="user.status_id === 1" title="Active user"><i class="fas fa-user-check green"></i></span>
            	<span v-show="user.status_id === 2" title="Inactive user"> <i class="fas fa-user-times yellow" style="font-size:18px !important;"></i></span>
            	<span v-show="user.status_id === 3" title="Panding user"> <i class="fas fa-user-lock red" style="font-size:18px !important;"></i></span>
            ...
            <td class="text-right">  
              ...
              <a @click="editData(user)" class="btn btn-primary- btn-flat btn-sm" data-toggle="modal" data-target="#userModal">
