    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="">
        	<span v-show="!editMode">Add Cash Account</span>
	...
	export default {
	    ...
	    methods:{
			...
			storeFormData() {  
			  ...
			  this.form.post('/spa/CashAccount-Info')
			  .then(({ data }) => { 
			...
			updateFormData(){         
				...
				this.form.put('/spa/CashAccount-Info/'+this.form.id)
				  .then(({ data }) => { 
	    ...
	    created(){
	    	...
	    	FireEvent.$on('editCashAccount', (data) => {
              //alert(data.id);
              //this.form.fill(data);   //this is also work
              this.editCashAccount(data);
            });

            FireEvent.$on('addCashAccount', () => {
              this.addCashAccount();
            });
	    }
