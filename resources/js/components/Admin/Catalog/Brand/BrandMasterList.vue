    ...
    <div class="card-header">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-3 text-right">
          ...
          <a @click="addBrand" class="btn btn-primary btn-flat btn-sm" data-toggle="modal" data-target="#formModal"> <i class="icon fas fa-plus"></i> Add New</a>
        </div>
      </div>
    </div><!--/card-header-->
    <div class="card-body">   
      <table class="table table-striped table-sm table-responsive-">
        ...
        <tbody>
          <tr v-for="(brand, index) in Brands" :key="index">
            ...
            <td class="text-right">    
              <a @click="editBrand(brand)" class="btn btn-primary- btn-flat btn-sm" data-toggle="modal" data-target="#formModal">
