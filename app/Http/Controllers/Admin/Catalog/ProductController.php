...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $data = Product::with('belongsToStatusMaster')->paginate($perPage);
    ...
    public function search(Request $request){
        ...
        //if($search = \Request::get('q')){
            $searchResult = Product::with('belongsToStatusMaster')
            ...
            $searchResult = Product::with('belongsToStatusMaster')->paginate($perPage);
        }
        //return $searchResult;
