(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["customer-address-website-auth~customer-dashboard-website-auth~customer-order-website-auth~customer-p~a2ff15f0"],{
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "user-panel pl-2 pr2 mt-2 pb-2 mb-1 d-flex border-bottom-primary- border-bottom"
      },
      [
        _c("div", { staticClass: "info" }, [
          _c("span", { staticClass: "font-size-16 text-black" }, [
            _vm._v(" Mahmudur Rahman ")
          ]),
          _vm._v(" "),
          _c("br"),
          _vm._v(" "),
          _c("span", { staticClass: "btn- px-1 bg-success text-white" }, [
            _c("i", { staticClass: "fas fa-check font-size-10" }),
            _vm._v(" Verified\n                    ")
          ])
        ])
      ]
